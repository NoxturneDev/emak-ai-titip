...
export default function LandingPage({ onLaunchDemo }) {
  ...
  return (
    <div className="min-h-screen text-slate-900 flex flex-col relative overflow-hidden bg-[#f3f4f6]">
      {/* Header / Navbar */}
      <header className="sticky top-0 z-50 bg-white border-b-4 border-slate-900 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-none border-2 border-slate-900 bg-emerald-400 flex items-center justify-center shadow-[2px_2px_0px_0px_#111827]">
            ...
            <div>
              ...
              <span className="hidden sm:inline-block ml-2 px-2 py-0.5 text-[10px] font-bold bg-amber-300 text-slate-900 border-2 border-slate-900 shadow-[1px_1px_0px_0px_#111827]">
                MVP Demo
              </span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <button 
              ...
              className="px-5 py-2 rounded-none text-sm font-bold bg-emerald-400 border-2 border-slate-900 text-slate-900 shadow-[3px_3px_0px_0px_#111827] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[4px_4px_0px_0px_#111827] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0px_0px_#111827] transition-all flex items-center gap-2 cursor-pointer"
            >
              Mulai Demo
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 border-2 border-slate-900 bg-white text-slate-900 shadow-[2px_2px_0px_0px_#111827] hover:bg-slate-100 transition-colors"
            >
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div 
              ...
              className="md:hidden border-t-2 border-slate-900 bg-white px-4 py-6"
            >
              <div className="flex flex-col gap-4 font-bold">
                ...
                <button 
                  ...
                  className="w-full mt-4 py-3 rounded-none font-bold bg-emerald-400 border-2 border-slate-900 text-slate-900 shadow-[3px_3px_0px_0px_#111827] flex items-center justify-center gap-2"
                >
                  Mulai Demo
                  <ArrowRight className="w-4 h-4" />
                </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col text-center lg:text-left items-center lg:items-start">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-none bg-amber-300 border-2 border-slate-900 text-slate-900 text-xs font-extrabold mb-6 shadow-[2px_2px_0px_0px_#111827]">
              ...
              <h1 className="font-display font-black text-4xl sm:text-5xl lg:text-6xl tracking-tight text-slate-900 leading-none mb-6">
                ...
                <span className="bg-emerald-400 px-3 py-1 inline-block border-3 border-slate-900 shadow-[4px_4px_0px_0px_#111827] mt-2">
                  Cukup Chat WhatsApp
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <button
                  onClick={onLaunchDemo}
                  className="px-8 py-4 rounded-none text-base font-black bg-emerald-400 border-3 border-slate-900 text-slate-900 shadow-[4px_4px_0px_0px_#111827] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[5px_5px_0px_0px_#111827] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[3px_3px_0px_0px_#111827] transition-all flex items-center justify-center gap-3 cursor-pointer"
                >
                  Buka Simulator Demo
                ...
                <a
                  href="#cara-kerja"
                  className="px-8 py-4 rounded-none text-base font-bold bg-white hover:bg-slate-50 text-slate-900 border-3 border-slate-900 shadow-[4px_4px_0px_0px_#111827] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[5px_5px_0px_0px_#111827] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[3px_3px_0px_0px_#111827] transition-all flex items-center justify-center gap-2"
                >
              ...
              {/* Quick Tech Specs */}
              <div className="mt-12 pt-8 border-t-3 border-slate-900 w-full grid grid-cols-3 gap-4 text-center lg:text-left">
                <div>
            ...
            <div className="lg:col-span-6 w-full max-w-2xl mx-auto lg:max-w-none">
              <div className="glass-panel p-6 rounded-none bg-white">
                <div className="flex items-center gap-2 text-xs font-mono font-bold border-b-3 border-slate-900 pb-3 mb-5 text-slate-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-2 border-slate-900 p-3 bg-emerald-100 flex items-center justify-between shadow-[2px_2px_0px_0px_#111827]">
                    <div className="flex items-center gap-2">
                      <MessageSquare className="w-4 h-4 text-emerald-600" />
                      <span className="font-extrabold text-xs">Customer (WhatsApp Chat)</span>
                    </div>
                    <span className="text-[10px] font-mono bg-white border-2 border-slate-900 px-1.5 font-bold">1. INPUT</span>
                  </div>
                  ...
                  <div className="border-2 border-slate-900 p-3 bg-sky-100 flex items-center justify-between shadow-[2px_2px_0px_0px_#111827]">
                    <div className="flex items-center gap-2">
                      <Zap className="w-4 h-4 text-sky-600" />
                      <span className="font-extrabold text-xs">Go Server & Fuzzy NLP Engine</span>
                    </div>
                    <span className="text-[10px] font-mono bg-white border-2 border-slate-900 px-1.5 font-bold">2. PROCESS</span>
                  </div>
                ...
                <div className="mt-5 pt-3 border-t-2 border-slate-900/60 flex items-center justify-between text-xs font-semibold">
      ...
      {/* Feature Section */}
      <section id="fitur" className="py-20 border-t-4 border-slate-900 relative bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Feature Card 1 */}
            <div className="glass-card p-8 rounded-none flex flex-col h-full bg-white">
              <div className="w-12 h-12 rounded-none bg-emerald-100 border-2 border-slate-900 flex items-center justify-center text-slate-900 mb-6 shadow-[2px_2px_0px_0px_#111827]">
      ...
      <section id="cara-kerja" className="py-20 border-t-4 border-slate-900 bg-slate-100 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-stretch relative">
            ...
            {/* Step 1 */}
            <div className="glass-card p-6 rounded-none flex flex-col relative bg-white">
              <div className="absolute top-4 right-4 text-3xl font-display font-black text-slate-200">01</div>
              <div className="w-10 h-10 rounded-none bg-emerald-100 border-2 border-slate-900 text-slate-900 flex items-center justify-center font-black text-sm mb-4 shadow-[2px_2px_0px_0px_#111827]">
                1
              </div>
            ...
            <div className="glass-card p-6 rounded-none flex flex-col relative bg-white">
              ...
              <div className="w-10 h-10 rounded-none bg-violet-100 border-2 border-slate-900 text-slate-900 flex items-center justify-center font-black text-sm mb-4 shadow-[2px_2px_0px_0px_#111827]">
                4
              </div>
      ...
      <section id="escrow" className="py-20 border-t-4 border-slate-900 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            
            {/* Visual Escrow Graphic */}
            <div className="lg:col-span-6 relative">
              <div className="relative glass-panel rounded-none p-6 bg-white">
                
                <div className="flex items-center justify-between border-b-2 border-slate-900 pb-4 mb-5">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-none bg-sky-100 border-2 border-slate-900 flex items-center justify-center text-slate-900 shadow-[2px_2px_0px_0px_#111827]">
                ...
                <div className="space-y-4 font-semibold text-xs">
                  <div className="flex justify-between items-center bg-slate-100 p-3 rounded-none border-2 border-slate-900 shadow-[2px_2px_0px_0px_#111827]">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white p-3 rounded-none border-2 border-slate-900 text-center shadow-[2px_2px_0px_0px_#111827]">
                  ...
                  <div className="flex justify-between items-center bg-emerald-100 p-3 rounded-none border-2 border-slate-900 shadow-[2px_2px_0px_0px_#111827]">
            ...
            <div className="lg:col-span-6 flex flex-col">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-8 h-8 rounded-none bg-sky-100 border-2 border-slate-900 flex items-center justify-center text-slate-900 shrink-0 shadow-[1px_1px_0px_0px_#111827]">
      ...
      <section id="arsitektur" className="py-20 border-t-4 border-slate-900 bg-slate-100 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="font-display font-black text-3xl sm:text-4xl text-slate-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="glass-card p-6 rounded-none bg-white">
            ...
            <div className="glass-card p-6 rounded-none bg-white">
              <div className="w-10 h-10 rounded-none bg-sky-100 border-2 border-slate-900 flex items-center justify-center mb-4 shadow-[2px_2px_0px_0px_#111827]">
            ...
            <div className="glass-card p-6 rounded-none bg-white">
              <div className="w-10 h-10 rounded-none bg-violet-100 border-2 border-slate-900 flex items-center justify-center mb-4 shadow-[2px_2px_0px_0px_#111827]">
      ...
      {/* CTA Section */}
      <section className="py-20 border-t-4 border-slate-900 relative bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-none bg-amber-300 border-3 border-slate-900 p-8 sm:p-12 text-center shadow-[4px_4px_0px_0px_#111827]">
            ...
            <button
              onClick={onLaunchDemo}
              className="mx-auto px-8 py-4 rounded-none text-base font-black bg-white border-3 border-slate-900 text-slate-900 hover:bg-slate-50 flex items-center justify-center gap-2 transition-all hover:scale-[1.01] hover:shadow-[5px_5px_0px_0px_#111827] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[3px_3px_0px_0px_#111827] cursor-pointer shadow-[4px_4px_0px_0px_#111827]"
            >
      ...
      {/* Footer */}
      <footer className="mt-auto py-12 border-t-4 border-slate-900 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-none border-2 border-slate-900 bg-emerald-400 flex items-center justify-center">
          ...
          <div className="flex flex-wrap gap-2 justify-center text-xs font-bold">
            <span className="px-2.5 py-1 bg-white border-2 border-slate-900 shadow-[1px_1px_0px_0px_#111827]">Go 1.25</span>
            <span className="px-2.5 py-1 bg-white border-2 border-slate-900 shadow-[1px_1px_0px_0px_#111827]">SQLite</span>
            <span className="px-2.5 py-1 bg-white border-2 border-slate-900 shadow-[1px_1px_0px_0px_#111827]">React 19</span>
            <span className="px-2.5 py-1 bg-white border-2 border-slate-900 shadow-[1px_1px_0px_0px_#111827]">Vite 8</span>
            <span className="px-2.5 py-1 bg-white border-2 border-slate-900 shadow-[1px_1px_0px_0px_#111827]">Tailwind v4</span>
          </div>
